...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T>
{
    ...
    public final boolean onInterceptTouchEvent(MotionEvent event)
    {
        ...
        switch (action)
        {
            ...
            {
                // If we're refreshing, and the flag is set. Eat all MOVE
                // events
        ...
        switch (event.getAction())
        {
            ...
            case MotionEvent.ACTION_UP:
            {
                if (mIsBeingDragged)
                {
                    ...
                    // If we're already refreshing, just scroll back to the
                    // top
                    if (isRefreshing())
                    {
                        smoothScrollTo(0);
                    ...
                    // If we haven't returned by here, then we're not in a
                    // state
    ...
    protected final Parcelable onSaveInstanceState()
    {
        ...
        // Let derivative classes get a chance to save state first, that way
        // we
    ...
    public static enum AnimationStyle
    {
        ...
        /**
         * This allows you to use any drawable, which is automatically rotated
        ...
        /**
         * Maps an int to a specific mode. This is needed when saving state,
         * or inflating the view from XML where the mode is given through a
         * attr int.
         * 
    ...
    public static enum Mode
    {
        ...
        /**
         * Only allow the user to Pull from the start of the Refreshable View
         * to refresh. The start is either the Top or Left, depending on the
         * scrolling direction.
         */
        PULL_FROM_START(0x1),
    ...
    public static interface OnPullEventListener<V extends View>
    {
         ...
         *            the user is pulling. Only useful when <var>state</var>
         *            is {@link State#PULL_TO_REFRESH} or
     ...
     * This listener is different as it allows you to differentiate between
