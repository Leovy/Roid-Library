...
import com.rincliu.library.widget.pulltorefresh.PullToRefreshBase.OnPullEventListener;
...
public interface IPullToRefresh<T extends View> {
     ...
     * trigger the View.
     * 
     * @param filterEvents - true if you want to filter Touch Events. Default
     *            is true.
     */
     ...
     * 
     * @param listener - Listener to be used when the Widget has a pull event
     *            to propogate.
     */
