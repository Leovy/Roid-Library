 ...
 */
package com.rincliu.library.widget.listpager;
...
public abstract class ListPagerAdapter implements ListPagerView.DataObserver {
    ...
    private void fetchData() {
        ...
        ConnectivityManager connManager = (ConnectivityManager) pager.context.getSystemService(Context.CONNECTIVITY_SERVICE);
