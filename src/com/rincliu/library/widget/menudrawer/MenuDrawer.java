...
public abstract class MenuDrawer extends ViewGroup
{
    ...
    /**
     * The drag mode of the drawer. Can be either {@link #MENU_DRAG_CONTENT}
     * or {@link #MENU_DRAG_WINDOW}.
     */
    ...
    /**
     * Indicates whether to use {@link View#LAYER_TYPE_HARDWARE} when
    ...
    /**
     * The start position of the indicator when animating it to a new
     * position.
     */
     ...
     *            {@link MenuDrawer#MENU_DRAG_WINDOW}.
     * @param position Where to position the menu.
     * @param attachStatic Whether a static (non-draggable, always visible)
    ...
    private static void attachToContent(Activity activity, MenuDrawer menuDrawer)
    {
         ...
         * to MenuDrawer#setContentView, which then again would call
    ...
    /**
     * Set the active view. If the mdActiveIndicator attribute is set, this
     * View will have the indicator drawn next to it.
     * 
    ...
    /**
     * Indicates whether the indicator should be animated between active
     * views.
     * 
     ...
     * 
     * @param delay The delay (in milliseconds) between each run of the
     *            animation. If 0, this animation is only run once.
     */
     ...
     * happens until the user opens the drawer.
     * 
     * @param startDelay The delay (in milliseconds) until the animation is
     *            first run.
     * @param delay The delay (in milliseconds) between each run of the
     *            animation. If 0, this animation is only run once.
     */
    ...
    /**
     * Sets the drawer touch mode. Possible values are
     * {@link #TOUCH_MODE_NONE}, {@link #TOUCH_MODE_BEZEL} or
     * {@link #TOUCH_MODE_FULLSCREEN}.
     * 
