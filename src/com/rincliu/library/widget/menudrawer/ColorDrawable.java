...
public class ColorDrawable extends Drawable
{
    ...
    /**
     * Sets the drawable's color value. This action will clobber the results
     * of prior calls to {@link #setAlpha(int)} on this object, which
     * side-affected the underlying color.
     * 
     * @param color The color to draw.
     */
