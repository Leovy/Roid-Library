...
public abstract class DraggableDrawer extends MenuDrawer {
     ...
     * progress.
     * 
     * @param dx The X difference between the last motion event and the
     ...
     * {@link net.rinc.library.widget.view.menudrawer.MenuDrawer#onTouchEvent(android.view.MotionEvent)}
     * .
     * 
     * @param ev The motion event.
     */
