...
public class Scroller
{
    ...
    /**
     * Create a Scroller with the specified interpolator. If the interpolator
     ...
     * @param startY Starting vertical scroll offset in pixels. Positive
     ...
     * @param velocityX Initial velocity of the fling (X) measured in pixels
     *            per second.
     * @param velocityY Initial velocity of the fling (Y) measured in pixels
     *            per second
