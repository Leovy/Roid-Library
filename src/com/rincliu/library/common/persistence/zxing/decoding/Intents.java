...
package com.rincliu.library.common.persistence.zxing.decoding;
...
public final class Intents
{
    ...
    public static final class Scan
    {
         ...
         * shorthnad for setting explicit formats with {@link #SCAN_FORMATS}.
        ...
        /**
         * Decode only 1D barcodes (currently UPC, EAN, Code 39, and Code
         * 128).
         */
        ...
        /**
         * Call intent.getStringExtra(RESULT_FORMAT) to determine which
         * barcode format was found. See Contents.Format for possible values.
         */
    ...
    public static final class Encode
    {
         ...
         * specified. Non-QR Code formats should just use a String here. For
         * QR Code, see Contents for details.
         */
