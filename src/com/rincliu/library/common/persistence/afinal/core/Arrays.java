...
public class Arrays {
    ...
    /**
     * Returns a {@code List} of the objects in the specified array. The size
     * of the {@code List} cannot be modified, i.e. adding and removing are
     * unsupported, but the elements can be set. Setting an element modifies
     ...
     * array {@code array}. Searching in an unsorted array has an undefined
     * result. It's also undefined which element is found if there are
     * multiple occurrences of the same element.
     * 
     * @param array the sorted array to search.
     * @param value the element to find.
     * @return the non-negative index of the element, or a negative index
     *         which is {@code -index - 1} where the element would be
     *         inserted.
     */
     ...
     *             {@code startIndex < 0 || endIndex > array.length}
     * @since 1.6
     */
    ...
    public static int binarySearch(double[] array, int startIndex, int endIndex, double value) {
        ...
        while (lo <= hi) {
            ...
            if (midVal < value) {
                ...
                return mid; // value found
            } else { // Either midVal and value are == 0 or at least one is
                     // NaN
                long midValBits = Double.doubleToLongBits(midVal);
                long valueBits = Double.doubleToLongBits(value);

                if (midValBits < valueBits) {
                    lo = mid + 1; // (-0.0, 0.0) or (not NaN, NaN); midVal <
                                  // val
                } else if (midValBits > valueBits) {
                    hi = mid - 1; // (0.0, -0.0) or (NaN, not NaN); midVal >
                                  // val
                } else {
     ...
     *         which is {@code -index - 1} where the element would be
     *         inserted.
     * @throws ClassCastException if an element in the array or the search
     *             element does not implement {@code Comparable}, or cannot be
    ...
    /**
     * Performs a binary search for {@code value} in the ascending sorted
     * array {@code array}, using {@code comparator} to compare elements.
     * Searching in an unsorted array has an undefined result. It's also
     * undefined which element is found if there are multiple occurrences of
     * the same element.
     * 
     * @param array the sorted array to search.
     * @param value the element to find.
     ...
     * Performs a binary search for {@code value} in the ascending sorted
     * array {@code array}, in the range specified by fromIndex (inclusive)
     * and toIndex (exclusive), using {@code comparator} to compare elements.
     * Searching in an unsorted array has an undefined result. It's also
     * undefined which element is found if there are multiple occurrences of
     * the same element.
     * 
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code boolean} arrays {@code a} and {@code b}, if
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two not-null {@code int} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code short} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code char} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code byte} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code long} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code float} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
    ...
    /**
     * Returns a hash code based on the contents of the given array. For any
     * two {@code double} arrays {@code a} and {@code b}, if
     * {@code Arrays.equals(a, b)} returns {@code true}, it means that the
     * return value of {@code Arrays.hashCode(a)} equals
     * {@code Arrays.hashCode(b)}.
     * <p>
     ...
     * method on an array that contains itself as an element, either directly
     * or indirectly.
     * <p>
     ...
     * Arrays.asList(array).hashCode(). If the array is {@code null}, the
     * return value is 0.
     * 
     * @param array the array whose hash code to compute.
     * @return the hash code for {@code array}.
     ...
     * on their contents not their identities. So it is not acceptable to
     * invoke this method on an array that contains itself as an element,
     ...
     * appropriate overloading of {@code Arrays.hashCode(e)} if e is an array
     * of a primitive type, or by calling {@code Arrays.deepHashCode(e)}
     * recursively if e is an array of a reference type. The value returned by
     * this method is the same value as the method
     * {@code Arrays.asList(array).hashCode()}. If the array is {@code null},
     ...
     * <p>
     * {@code element1} and {@code element2} are both arrays of object
     * reference types, and {@code Arrays.deepEquals(element1, element2)}
     ...
     * @throws ArrayIndexOutOfBoundsException if {@code start < 0} or
     *             {@code end > array.length}.
     */

    /**
     * Creates a {@code String} representation of the {@code boolean[]}
     * passed. The result is surrounded by brackets ({@code "[]"}), each
     * element is converted to a {@code String} via the
     * {@link String#valueOf(boolean)} and separated by {@code ", "}. If the
     * array is {@code null}, then {@code "null"} is returned.
     * 
    ...
    /**
     * Creates a {@code String} representation of the {@code byte[]} passed.
    ...
    /**
     * Creates a {@code String} representation of the {@code char[]} passed.
     * The result is surrounded by brackets ({@code "[]"}), each element is
     ...
     * The result is surrounded by brackets ({@code "[]"}), each element is
     * converted to a {@code String} via the {@link String#valueOf(double)}
     * and separated by {@code ", "}. If the array is {@code null}, then
     * {@code "null"} is returned.
     * 
    ...
    /**
     * Creates a {@code String} representation of the {@code int[]} passed.
     * The result is surrounded by brackets ({@code "[]"}), each element is
     * converted to a {@code String} via the {@link String#valueOf(int)} and
     * separated by {@code ", "}. If the array is {@code null}, then
     * {@code "null"} is returned.
    ...
    /**
     * Creates a {@code String} representation of the {@code long[]} passed.
     * The result is surrounded by brackets ({@code "[]"}), each element is
     ...
     * The result is surrounded by brackets ({@code "[]"}), each element is
     * converted to a {@code String} via the {@link String#valueOf(Object)}
     * and separated by {@code ", "}. If the array is {@code null}, then
     * {@code "null"} is returned.
     * 
     ...
     * <p>
     * If any of the elements are primitive arrays, the generation is
     * delegated to the other {@code toString} methods in this class. If any
     * element contains a reference to the original array, then it will be
     * represented as {@code "[...]"}. If an element is an {@code Object[]},
     * then its representation is generated by a recursive call to this
     * method. All other elements are converted via the
    ...
    /**
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code false}.
     * 
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code (byte) 0}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code '\\u0000'}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code 0.0d}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code 0.0f}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code 0}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code 0L}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code (short) 0}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * Copies {@code newLength} elements from {@code original} into a new
     * array. If {@code newLength} is greater than {@code original.length},
     * the result is padded with the value {@code null}.
     * 
     * @param original the original array
     * @param newLength the length of the new array
     * @return the new array
     ...
     * @throws NegativeArraySizeException if {@code newLength < 0}
     * @throws NullPointerException if {@code original == null}
     * @throws ArrayStoreException if a value in {@code original} is
     *             incompatible with T
     * @since 1.6
     */
