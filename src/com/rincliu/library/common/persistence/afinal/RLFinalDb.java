...
import com.rincliu.library.common.persistence.afinal.db.sqlite.CursorUtils;
import com.rincliu.library.common.persistence.afinal.db.sqlite.DbModel;
import com.rincliu.library.common.persistence.afinal.db.sqlite.SqlBuilder;
import com.rincliu.library.common.persistence.afinal.db.sqlite.SqlInfo;
...
public class RLFinalDb {
	...
	private static HashMap<String, RLFinalDb> daoMap = new HashMap<String, RLFinalDb>();
	 ...
	 * @return
	 */
	public static RLFinalDb create(Context context,String dbName,boolean isDebug,int dbVersion,DbUpdateListener dbUpdateListener){
		DaoConfig config = new DaoConfig();
		config.setContext(context);
		config.setDbName(dbName);
		config.setDebug(isDebug);
