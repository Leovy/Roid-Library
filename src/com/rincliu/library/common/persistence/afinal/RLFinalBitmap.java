 ...
 */
package com.rincliu.library.common.persistence.afinal;
...
import com.rincliu.library.common.persistence.afinal.bitmap.core.BitmapCache;
import com.rincliu.library.common.persistence.afinal.bitmap.core.BitmapCommonUtils;
import com.rincliu.library.common.persistence.afinal.bitmap.core.BitmapDisplayConfig;
import com.rincliu.library.common.persistence.afinal.bitmap.core.BitmapProcess;
import com.rincliu.library.common.persistence.afinal.bitmap.display.Displayer;
import com.rincliu.library.common.persistence.afinal.bitmap.display.SimpleDisplayer;
import com.rincliu.library.common.persistence.afinal.bitmap.download.Downloader;
import com.rincliu.library.common.persistence.afinal.bitmap.download.SimpleHttpDownloader;
import com.rincliu.library.common.persistence.afinal.core.AsyncTask;

public class RLFinalBitmap {
	...
	private static RLFinalBitmap mFinalBitmap;
	////////////////////////// config method start////////////////////////////////////
	private RLFinalBitmap(Context context) {
		mContext = context;
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.init();
		}
		return mFinalBitmap;
	}
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath,float memoryCacheSizePercent){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.configDiskCachePath(diskCachePath);
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath,int memoryCacheSize){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.configDiskCachePath(diskCachePath);
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath,float memoryCacheSizePercent,int threadSize){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.configDiskCachePath(diskCachePath);
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath,int memoryCacheSize,int threadSize){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.configDiskCachePath(diskCachePath);
			mFinalBitmap.configBitmapLoadThreadSize(threadSize);
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath,float memoryCacheSizePercent,int diskCacheSize,int threadSize){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.configDiskCachePath(diskCachePath);
			mFinalBitmap.configBitmapLoadThreadSize(threadSize);
	 ...
	 * @return
	 */
	public static RLFinalBitmap create(Context ctx,String diskCachePath,int memoryCacheSize,int diskCacheSize,int threadSize){
		if(mFinalBitmap == null){
			mFinalBitmap = new RLFinalBitmap(ctx.getApplicationContext());
			mFinalBitmap.configDiskCachePath(diskCachePath);
			mFinalBitmap.configBitmapLoadThreadSize(threadSize);
	 ...
	 * @param bitmap
	 */
	public RLFinalBitmap configLoadingImage(Bitmap bitmap) {
	 ...
	 * @param bitmap
	 */
	public RLFinalBitmap configLoadingImage(int resId) {
	 ...
	 * @param bitmap
	 */
	public RLFinalBitmap configLoadfailImage(Bitmap bitmap) {
	 ...
	 * @param resId
	 */
	public RLFinalBitmap configLoadfailImage(int resId) {
	 ...
	 * @param bitmapHeight
	 */
	public RLFinalBitmap configBitmapMaxHeight(int bitmapHeight){
	 ...
	 * @param bitmapHeight
	 */
	public RLFinalBitmap configBitmapMaxWidth(int bitmapWidth){
	 ...
	 * @return
	 */
	public RLFinalBitmap configDownlader(Downloader downlader){
	 ...
	 * @return
	 */
	public RLFinalBitmap configDisplayer(Displayer displayer){
	 ...
	 */
	public RLFinalBitmap configCalculateBitmapSizeWhenDecode(boolean neverCalculate){
	 ...
	 * @return
	 */
	private RLFinalBitmap configDiskCachePath(String strPath){
	 ...
	 * @param size 缓存大小
	 */
	private RLFinalBitmap configMemoryCacheSize(int size){
	 ...
	 */
	private RLFinalBitmap configMemoryCachePercent(float percent){
	 ...
	 * @param size
	 */
	private RLFinalBitmap configDiskCacheSize(int size){
	 ...
	 * @param size
	 */
	private RLFinalBitmap configBitmapLoadThreadSize(int size){
		if(size >= 1)
	...
	/**
	 * 这个方法必须被调用后 RLFinalBitmap 配置才能有效
	 * @return
	 */
	private RLFinalBitmap init(){
	...
	public void display(ImageView imageView,String uri,Bitmap loadingBitmap,Bitmap loadfailBitmap){
		BitmapDisplayConfig displayConfig = configMap.get(String.valueOf(loadingBitmap)+"_"+String.valueOf(loadfailBitmap));
		if(displayConfig==null){
			displayConfig = getDisplayConfig();
			displayConfig.setLoadingBitmap(loadingBitmap);
			displayConfig.setLoadfailBitmap(loadfailBitmap);
			configMap.put(String.valueOf(loadingBitmap)+"_"+String.valueOf(loadfailBitmap), displayConfig);
		}
		
		doDisplay(imageView,uri,displayConfig);
	}
	
	public void display(ImageView imageView,String uri,int imageWidth,int imageHeight,Bitmap loadingBitmap,Bitmap loadfailBitmap){
		BitmapDisplayConfig displayConfig = configMap.get(imageWidth+"_"+imageHeight+"_"+String.valueOf(loadingBitmap)+"_"+String.valueOf(loadfailBitmap));
		if(displayConfig==null){
			displayConfig = getDisplayConfig();
			displayConfig.setBitmapHeight(imageHeight);
			displayConfig.setBitmapWidth(imageWidth);
			displayConfig.setLoadingBitmap(loadingBitmap);
			displayConfig.setLoadfailBitmap(loadfailBitmap);
			configMap.put(imageWidth+"_"+imageHeight+"_"+String.valueOf(loadingBitmap)+"_"+String.valueOf(loadfailBitmap), displayConfig);
		}
