...
import com.rincliu.library.common.persistence.afinal.http.AjaxCallBack;
import com.rincliu.library.common.persistence.afinal.http.AjaxParams;
import com.rincliu.library.common.persistence.afinal.http.HttpHandler;
import com.rincliu.library.common.persistence.afinal.http.RetryHandler;
import com.rincliu.library.common.persistence.afinal.http.SyncRequestHandler;
...
public class RLFinalHttp {
    ...
    private static final ThreadFactory  sThreadFactory = new ThreadFactory() {
        ...
        public Thread newThread(Runnable r) {
        	Thread tread = new Thread(r, "RLFinalHttp #" + mCount.getAndIncrement());
