 ...
 *******************************************************************************/
package com.rincliu.library.common.persistence.image.cache.disc.impl;

import com.rincliu.library.common.persistence.image.cache.disc.LimitedDiscCache;
import com.rincliu.library.common.persistence.image.cache.disc.naming.FileNameGenerator;
import com.rincliu.library.common.persistence.image.core.DefaultConfigurationFactory;
import com.rincliu.library.common.persistence.image.utils.L;

import java.io.File;

/**
 * Disc cache limited by total cache size. If cache size exceeds specified
