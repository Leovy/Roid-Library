...
/**
 * Utility for generating of keys for memory cache, key comparing and other
 * work with memory cache
 * 
...
public final class MemoryCacheUtil
{
     ...
     * URI.<br />
     * <b>Note:</b> Memory cache can contain multiple sizes of the same image
     * if only you didn't set
    ...
    /**
     * Searches all keys in memory cache which are corresponded to incoming
     * URI.<br />
     * <b>Note:</b> Memory cache can contain multiple sizes of the same image
     * if only you didn't set
     * {@link ImageLoaderConfiguration.Builder#denyCacheImageMultipleSizesInMemory()
