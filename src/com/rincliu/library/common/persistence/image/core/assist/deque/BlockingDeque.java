 ...
 * returns a special value (either <tt>null</tt> or <tt>false</tt>, depending
 * on the operation), the third blocks the current thread indefinitely until
 * the operation can succeed, and the fourth blocks for only a given maximum
 ...
 * </table>
 * <p>
 * Like any {@link BlockingQueue}, a <tt>BlockingDeque</tt> is thread safe,
 ...
 * in a thread prior to placing an object into a {@code BlockingDeque} <a
...
public interface BlockingDeque<E> extends BlockingQueue<E>, Deque<E>
{
     ...
     * currently available. When using a capacity-restricted deque, this
     * method is generally preferable to the {@link #addFirst addFirst}
     ...
     * returning <tt>true</tt> upon success and <tt>false</tt> if no space is
     * currently available. When using a capacity-restricted deque, this
     * method is generally preferable to the {@link #addLast addLast} method,
    ...
    /**
     * Inserts the specified element at the end of this deque, waiting up to
     * the specified wait time if necessary for space to become available.
     * 
     * @param e the element to add
     * @param timeout how long to wait before giving up, in units of
    ...
    /**
     * Retrieves and removes the first element of this deque, waiting up to
     ...
     * <tt>o.equals(e)</tt> (if such an element exists). Returns <tt>true</tt>
