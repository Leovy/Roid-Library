 ...
 * ends. The name <i>deque</i> is short for "double ended queue" and is
 * usually pronounced "deck". Most <tt>Deque</tt> implementations place no
 ...
 * deque. Methods are provided to insert, remove, and examine the element.
 ...
 * </table>
 * <p>
 * This interface extends the {@link Queue} interface. When a deque is used as
 * a queue, FIFO (First-In-First-Out) behavior results. Elements are added at
 * the end of the deque and removed from the beginning. The methods inherited
 * from the <tt>Queue</tt> interface are precisely equivalent to
 ...
 * should be used in preference to the legacy {@link Stack} class. When a
 * deque is used as a stack, elements are pushed and popped from the beginning
 * of the deque. Stack methods are precisely equivalent to <tt>Deque</tt>
 ...
 * Users of any <tt>Deque</tt> implementations that do allow null elements are
 * strongly encouraged <i>not</i> to take advantage of the ability to insert
 * nulls. This is so because <tt>null</tt> is used as a special return value
 * by various methods to indicated that the deque is empty.
 * <p>
 * <tt>Deque</tt> implementations generally do not define element-based
 * versions of the <tt>equals</tt> and <tt>hashCode</tt> methods, but instead
...
public interface Deque<E> extends Queue<E> {
     ...
     * deque, this method is generally preferable to the {@link #addFirst}
     ...
     * formally, removes the first element <tt>e</tt> such that
     ...
     * @return <tt>true</tt> if an element was removed as a result of this
     *         call
     ...
     * If the deque does not contain the element, it is unchanged. More
     * formally, removes the last element <tt>e</tt> such that
     * <tt>(o==null&nbsp;?&nbsp;e==null&nbsp;:&nbsp;o.equals(e))</tt> (if such
     * an element exists). Returns <tt>true</tt> if this deque contained the
     * specified element (or equivalently, if this deque changed as a result
     * of the call).
     ...
     * (in other words, the first element of this deque). This method differs
     ...
     * method differs from {@link #peek peek} only in that it throws an
     * exception if this deque is empty.
     * <p>
