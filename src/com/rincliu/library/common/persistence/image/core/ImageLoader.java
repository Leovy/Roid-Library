...
import com.rincliu.library.common.persistence.image.core.display.FakeBitmapDisplayer;
import com.rincliu.library.common.persistence.image.utils.ImageSizeUtils;
...
public class ImageLoader
{
     ...
     * If configurations was set before ( {@link #isInited()} == true) then
     ...
     * 
     * @param denyNetworkDownloads pass <b>true</b> - to deny engine to
    ...
    /**
     * {@linkplain #stop() Stops ImageLoader} and clears current
     * configuration. <br />
