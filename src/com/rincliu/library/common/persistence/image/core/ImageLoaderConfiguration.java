...
import com.rincliu.library.common.persistence.image.cache.disc.impl.UnlimitedDiscCache;
import com.rincliu.library.common.persistence.image.cache.disc.naming.FileNameGenerator;
import com.rincliu.library.common.persistence.image.cache.memory.MemoryCacheAware;
import com.rincliu.library.common.persistence.image.cache.memory.impl.FuzzyKeyMemoryCache;
import com.rincliu.library.common.persistence.image.core.assist.MemoryCacheUtil;
...
import com.rincliu.library.common.persistence.image.core.download.NetworkDeniedImageDownloader;
import com.rincliu.library.common.persistence.image.core.download.SlowNetworkImageDownloader;
import com.rincliu.library.common.persistence.image.core.process.BitmapProcessor;
...
public final class ImageLoaderConfiguration
{
    ...
    public static class Builder
    {
         ...
         * 
         * @param maxImageWidthForMemoryCache Maximum image width which will
         ...
         * <b>NOTE: Use this option only when you have appropriate needs. It
         * can make ImageLoader slower.</b>
         * 
         * @param maxImageWidthForDiscCache Maximum width of downloaded images
         *            for saving at disc cache
         * @param maxImageHeightForDiscCache Maximum height of downloaded
         *            images for saving at disc cache
         ...
         *            Bitmap processor} which process images before saving
         *            them in disc cache
         */
         ...
         * <br />
         * <b>NOTE:</b> If you set custom executor then following
         * configuration options will not be considered for this executor:
         * <ul>
         ...
         * <b>cached on disc</b> images (these tasks are executed quickly so
         * UIL prefer to use separate executor for them).<br />
         * <br />
         * If you set the same executor for
         * {@linkplain #taskExecutor(Executor) general tasks} and
         * {@linkplain #taskExecutorForCachedImages(Executor) tasks about
         * cached images} then these tasks will be in the same thread pool. So
         ...
         * {@link android.widget.ImageView ImageView} and later you try to
         * display this image (from identical URI) in a larger
         * {@link android.widget.ImageView ImageView} so decoded image of
         * bigger size will be cached in memory as a previous decoded image of
         * smaller size.<br />
         * So <b>the default behavior is to allow to cache multiple sizes of
         * one image in memory</b>. You can <b>deny</b> it by calling
         * <b>this</b> method: so when some image will be cached in memory
         * then previous cached size of this image (if it exists) will be
         ...
         * {@link com.rincliu.library.common.persistence.image.cache.memory.impl.LruMemoryCache
         ...
         * <b>NOTE:</b> If you use this method then
         * {@link com.rincliu.library.common.persistence.image.cache.disc.impl.TotalSizeLimitedDiscCache
         ...
         * By default: disc cache is unlimited.<br />
         * <b>NOTE:</b> If you use this method then
         * {@link com.rincliu.library.common.persistence.image.cache.disc.impl.FileCountLimitedDiscCache
         ...
         * Default value -
         * {@link com.rincliu.library.common.persistence.image.core.DefaultConfigurationFactory#createFileNameGenerator()
         ...
         * Default value -
         * {@link com.rincliu.library.common.persistence.image.core.DefaultConfigurationFactory#createImageDownloader(Context)
        ...
        /**
         * Sets utility which will be responsible for decoding of image
         * stream.<br />
         * Default value -
         * {@link com.rincliu.library.common.persistence.image.core.DefaultConfigurationFactory#createImageDecoder(boolean)
         ...
         * Default value -
         * {@link com.rincliu.library.common.persistence.image.cache.disc.impl.UnlimitedDiscCache
         * UnlimitedDiscCache}. Cache directory is defined by
         * {@link com.rincliu.library.common.persistence.image.utils.StorageUtils#getCacheDirectory(Context)
        ...
        /**
         * Enables detail logging of {@link ImageLoader} work. To prevent
         * detail logs don't call this method. Consider
         * {@link com.rincliu.library.common.persistence.image.utils.L#disableLogging()}
