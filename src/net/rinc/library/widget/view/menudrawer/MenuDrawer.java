package net.rinc.library.widget.view.menudrawer;
...
public abstract class MenuDrawer extends ViewGroup {
    ...
    protected void initDrawer(Context context, AttributeSet attrs, int defStyle) {
        ...
        ViewCompat.setBackground(mMenuContainer, menuBackground);
        ...
        ViewCompat.setBackground(mContentContainer, contentBackground);
