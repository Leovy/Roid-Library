 ...
 */
package net.rinc.library.common.persistence.afinal.db.table;
...
import net.rinc.library.common.persistence.afinal.reflect.ClassUtils;
import net.rinc.library.common.persistence.afinal.reflect.FieldUtils;
